  ...
  return (
    <div className={styles.overlay}>
      <div className={styles.modal} role="dialog" aria-labelledby="warning-title" aria-modal="true">
        ...
        <button onClick={onDismiss} className={styles.button} aria-label="Continue playing">
          Continue Playing
        </button>

        <p className={styles.footer}>You will be returned to the menu if you remain inactive.</p>
      </div>
    </div>
  )
}
